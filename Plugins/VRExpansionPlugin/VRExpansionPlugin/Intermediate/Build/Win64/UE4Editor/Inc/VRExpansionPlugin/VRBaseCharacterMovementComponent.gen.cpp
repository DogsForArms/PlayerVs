...
static struct FScriptStruct_VRExpansionPlugin_StaticRegisterNativesFVRMoveActionContainer
{
	...
	UFunction* Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_Teleport()
	{
		...
		if (!ReturnFunction)
		{
			auto NewProp_bSkipEncroachmentCheck_SetBit = [](void* Obj){ ((VRBaseCharacterMovementComponent_eventPerformMoveAction_Teleport_Parms*)Obj)->bSkipEncroachmentCheck = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bSkipEncroachmentCheck = { UE4CodeGen_Private::EPropertyClass::Bool, "bSkipEncroachmentCheck", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(VRBaseCharacterMovementComponent_eventPerformMoveAction_Teleport_Parms), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bSkipEncroachmentCheck_SetBit)>::SetBit, METADATA_PARAMS(nullptr, 0) };
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bSkipEncroachmentCheck,
	...
	UClass* Z_Construct_UClass_UVRBaseCharacterMovementComponent()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				...
				{ &Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_Teleport, "PerformMoveAction_Teleport" }, // 1779155368
	...
	IMPLEMENT_CLASS(UVRBaseCharacterMovementComponent, 426526181);

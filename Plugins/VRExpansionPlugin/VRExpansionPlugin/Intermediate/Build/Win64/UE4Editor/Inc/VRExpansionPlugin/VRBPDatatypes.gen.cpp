...
static struct FScriptStruct_VRExpansionPlugin_StaticRegisterNativesFBPInterfaceProperties
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FBPInterfaceProperties()
	{
		...
		if (!ReturnStruct)
		{
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_HoldingController = { UE4CodeGen_Private::EPropertyClass::Object, "HoldingController", RF_Public|RF_Transient|RF_MarkAsNative, 0x001000008008001c, 1, nullptr, STRUCT_OFFSET(FBPInterfaceProperties, HoldingController), Z_Construct_UClass_UGripMotionControllerComponent_NoRegister, METADATA_PARAMS(NewProp_HoldingController_MetaData, ARRAY_COUNT(NewProp_HoldingController_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bIsHeld = { UE4CodeGen_Private::EPropertyClass::Bool, "bIsHeld", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000080000014, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(FBPInterfaceProperties), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bIsHeld_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bIsHeld_MetaData, ARRAY_COUNT(NewProp_bIsHeld_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FBPInterfaceProperties_CRC() { return 4006351963U; }
...
static struct FScriptStruct_VRExpansionPlugin_StaticRegisterNativesFBPAdvGripSettings
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FBPAdvGripSettings()
	{
		...
		if (!ReturnStruct)
		{
...
#endif
			auto NewProp_bSetOwnerOnGrip_SetBit = [](void* Obj){ ((FBPAdvGripSettings*)Obj)->bSetOwnerOnGrip = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bSetOwnerOnGrip = { UE4CodeGen_Private::EPropertyClass::Bool, "bSetOwnerOnGrip", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(FBPAdvGripSettings), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bSetOwnerOnGrip_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bSetOwnerOnGrip_MetaData, ARRAY_COUNT(NewProp_bSetOwnerOnGrip_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bSetOwnerOnGrip,
	...
	uint32 Get_Z_Construct_UScriptStruct_FBPAdvGripSettings_CRC() { return 741216953U; }

...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_NewPlayerState = { UE4CodeGen_Private::EPropertyClass::Object, "NewPlayerState", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000082, 1, nullptr, STRUCT_OFFSET(_Script_VRExpansionPlugin_eventVRPlayerStateReplicatedSignature_Parms, NewPlayerState), Z_Construct_UClass_APlayerState_NoRegister, METADATA_PARAMS(NewProp_NewPlayerState_MetaData, ARRAY_COUNT(NewProp_NewPlayerState_MetaData)) };
...
static struct FScriptStruct_VRExpansionPlugin_StaticRegisterNativesFVRSeatedCharacterInfo
{
...
#endif
			static const UE4CodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnPlayerStateReplicated_Bind = { UE4CodeGen_Private::EPropertyClass::MulticastDelegate, "OnPlayerStateReplicated_Bind", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000010080000, 1, nullptr, STRUCT_OFFSET(AVRBaseCharacter, OnPlayerStateReplicated_Bind), Z_Construct_UDelegateFunction_VRExpansionPlugin_VRPlayerStateReplicatedSignature__DelegateSignature, METADATA_PARAMS(NewProp_OnPlayerStateReplicated_Bind_MetaData, ARRAY_COUNT(NewProp_OnPlayerStateReplicated_Bind_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_OnPlayerStateReplicated_Bind,
			};
	...
	IMPLEMENT_CLASS(AVRBaseCharacter, 50970801);

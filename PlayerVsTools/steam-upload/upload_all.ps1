...
$GameBuildMacDir = (Get-Location).tostring() + "\upload-scripts-907100-mac\app_build_player_vs.vdf"
...
steamcmd +login $Credentials[0] $Credentials[1] +run_app_build $GameBuildDir +run_app_build $DedicatedBuildDir +run_app_build $GameBuildMacDir +quit